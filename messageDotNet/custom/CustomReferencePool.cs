 ...
 * @FilePath: /meland-scene-server/Assets/Plugins/SharedCore/game-message-core/messageDotNet/custom/CustomReferencePool.cs
 * 
 */
...
public static class CustomReferencePool
{
    ...
    public static void Release(object reference)
    {
        if (reference == null)
        {
            throw new Exception("Custom Reference is invalid.");
        }
