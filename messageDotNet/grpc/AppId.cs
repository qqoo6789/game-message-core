...
/// <summary>
/// GAME service APPID, 注意(scene/agent)的appId为启动服务时动态配置的
/// </summary>
public static class GRPCAppId
{
    public const string GAME_SERVICE_APPID_MANAGER = "game-service-manager";
    public const string GAME_SERVICE_APPID_MAIN = "game-service-main";
