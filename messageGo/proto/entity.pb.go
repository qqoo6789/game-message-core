...
func (x *EntityWithLocation) GetMovement() *EntityMovement {
	if x != nil {
		return x.Movement
	}
	return nil
...
func (x *EntityWithLocation) GetHomeAnimal() *HomeAnimal {
	if x, ok := x.GetEntity().(*EntityWithLocation_HomeAnimal); ok {
		return x.HomeAnimal
	}
	return nil
}
...
type EntityWithLocation_HomeAnimal struct {
	HomeAnimal *HomeAnimal `protobuf:"bytes,15,opt,name=homeAnimal,proto3,oneof"`
}
...
func (*EntityWithLocation_HomeAnimal) isEntityWithLocation_Entity() {}
...
type Player struct {
	...
	Avatars  []*AvatarAttribute `protobuf:"bytes,3,rep,name=avatars,proto3" json:"avatars,omitempty"` // 玩家 avatar
	...
	IsBattle        bool      `protobuf:"varint,10,opt,name=is_battle,json=isBattle,proto3" json:"is_battle,omitempty"` //战斗状态
	// repeated bian.proto.EntityBuff buff_list = 28;
	CaptureData *CaptureData `protobuf:"bytes,11,opt,name=capture_data,json=captureData,proto3" json:"capture_data,omitempty"` //捕获数据
	RandomSeed  int32        `protobuf:"varint,12,opt,name=randomSeed,proto3" json:"randomSeed,omitempty"`                     //随机种子
}
...
func (x *Player) GetAvatars() []*AvatarAttribute {
	if x != nil {
		return x.Avatars
	}
	return nil
...
func (x *Player) GetIsBattle() bool {
	if x != nil {
		return x.IsBattle
	}
	return false
...
func (x *Player) GetCaptureData() *CaptureData {
	if x != nil {
		return x.CaptureData
	}
	return nil
}

func (x *Player) GetRandomSeed() int32 {
	if x != nil {
		return x.RandomSeed
	}
	return 0
...
type Monster struct {
	...
	IsBattle        bool             `protobuf:"varint,8,opt,name=is_battle,json=isBattle,proto3" json:"is_battle,omitempty"`          //战斗状态
	OwnerId         int64            `protobuf:"varint,9,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty"`             //战斗所属者
	CaptureData     *CaptureData     `protobuf:"bytes,10,opt,name=capture_data,json=captureData,proto3" json:"capture_data,omitempty"` //捕获数据
	EquipmentSkills []int32          `protobuf:"varint,11,rep,packed,name=equipmentSkills,proto3" json:"equipmentSkills,omitempty"`    // 装备技能列表
	BtreeData       *BTreeData       `protobuf:"bytes,12,opt,name=btreeData,proto3" json:"btreeData,omitempty"`                        //行为树数据
}
...
func (x *Monster) GetIsBattle() bool {
	if x != nil {
		return x.IsBattle
	}
	return false
...
func (x *Monster) GetOwnerId() int64 {
	if x != nil {
		return x.OwnerId
	}
	return 0
...
func (x *Monster) GetCaptureData() *CaptureData {
	if x != nil {
		return x.CaptureData
	}
	return nil
...
func (x *Monster) GetEquipmentSkills() []int32 {
	if x != nil {
...
func (x *Monster) GetBtreeData() *BTreeData {
	if x != nil {
		return x.BtreeData
	}
	return nil
...
type Resource struct {
	...
	ProgressInfo *CollectResourceProgressResult `protobuf:"bytes,5,opt,name=progressInfo,proto3" json:"progressInfo,omitempty"`
}
...
func (x *Resource) GetProgressInfo() *CollectResourceProgressResult {
	if x != nil {
...
type HomeAnimal struct {
	...
	Position         *Vector3             `protobuf:"bytes,2,opt,name=position,proto3" json:"position,omitempty"`
	Dir              *Vector3             `protobuf:"bytes,3,opt,name=dir,proto3" json:"dir,omitempty"` // 方向（朝向）
	AnimalBaseData   *ProxyAnimalBaseData `protobuf:"bytes,4,opt,name=animalBaseData,proto3" json:"animalBaseData,omitempty"`
	AnimalDetailData *ProxyAnimalData     `protobuf:"bytes,5,opt,name=animalDetailData,proto3" json:"animalDetailData,omitempty"`
	Profile          []*AttributeData     `protobuf:"bytes,6,rep,name=profile,proto3" json:"profile,omitempty"`
}

func (x *HomeAnimal) Reset() {
	*x = HomeAnimal{}
	if protoimpl.UnsafeEnabled {
...
func (x *HomeAnimal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HomeAnimal) ProtoMessage() {}

func (x *HomeAnimal) ProtoReflect() protoreflect.Message {
	mi := &file_entity_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HomeAnimal.ProtoReflect.Descriptor instead.
func (*HomeAnimal) Descriptor() ([]byte, []int) {
	return file_entity_proto_rawDescGZIP(), []int{9}
}

func (x *HomeAnimal) GetPosition() *Vector3 {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *HomeAnimal) GetDir() *Vector3 {
	if x != nil {
		return x.Dir
	}
	return nil
...
func (x *HomeAnimal) GetAnimalBaseData() *ProxyAnimalBaseData {
	if x != nil {
		return x.AnimalBaseData
	}
	return nil
}

func (x *HomeAnimal) GetAnimalDetailData() *ProxyAnimalData {
	if x != nil {
		return x.AnimalDetailData
	}
	return nil
}

func (x *HomeAnimal) GetProfile() []*AttributeData {
	if x != nil {
		return x.Profile
	}
	return nil
...
type BTreePhaseProgress struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BTreePhaseProgress) Reset() {
	*x = BTreePhaseProgress{}
	if protoimpl.UnsafeEnabled {
...
func (x *BTreePhaseProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BTreePhaseProgress) ProtoMessage() {}

func (x *BTreePhaseProgress) ProtoReflect() protoreflect.Message {
	mi := &file_entity_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BTreePhaseProgress.ProtoReflect.Descriptor instead.
func (*BTreePhaseProgress) Descriptor() ([]byte, []int) {
	return file_entity_proto_rawDescGZIP(), []int{16}
}

func (x *BTreePhaseProgress) GetPhase() int32 {
	if x != nil {
		return x.Phase
	}
	return 0
...
func (x *BTreePhaseProgress) GetProgress() int32 {
	if x != nil {
		return x.Progress
	}
	return 0
...
type BTreeData struct {
	...
	Phase             int32                 `protobuf:"varint,1,opt,name=phase,proto3" json:"phase,omitempty"`
	PhaseTime         int64                 `protobuf:"varint,2,opt,name=phaseTime,proto3" json:"phaseTime,omitempty"`
	PhaseProgressList []*BTreePhaseProgress `protobuf:"bytes,3,rep,name=phaseProgressList,proto3" json:"phaseProgressList,omitempty"`
}

func (x *BTreeData) Reset() {
	*x = BTreeData{}
	if protoimpl.UnsafeEnabled {
...
func (x *BTreeData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BTreeData) ProtoMessage() {}

func (x *BTreeData) ProtoReflect() protoreflect.Message {
	mi := &file_entity_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BTreeData.ProtoReflect.Descriptor instead.
func (*BTreeData) Descriptor() ([]byte, []int) {
	return file_entity_proto_rawDescGZIP(), []int{17}
}

func (x *BTreeData) GetPhase() int32 {
	if x != nil {
		return x.Phase
	}
	return 0
...
func (x *BTreeData) GetPhaseTime() int64 {
	if x != nil {
		return x.PhaseTime
	}
	return 0
...
func (x *BTreeData) GetPhaseProgressList() []*BTreePhaseProgress {
	if x != nil {
		return x.PhaseProgressList
	}
	return nil
}
...
var file_entity_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0a, 0x68, 0x6f, 0x6d, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x0d, 0x63, 0x61, 0x70, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0x4b, 0x0a, 0x08, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x04, 0x74,
	...
	,
	...
	0x08, 0x6d, 0x6f, 0x76, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x31, 0x0a, 0x06, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x61, 0x6d, 0x65,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x50, 0x6c, 0x61, 0x79,
	0x65, 0x72, 0x48, 0x00, 0x52, 0x06, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x07,
	0x6d, 0x6f, 0x6e, 0x73, 0x74, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	,
	...
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x07, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x73, 0x12,
	0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x15, 0x0a, 0x06, 0x6d, 0x61, 0x70, 0x5f, 0x69,
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6d, 0x61, 0x70, 0x49, 0x64, 0x12, 0x34,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x03, 0x64, 0x69, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	,
	...
	0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	...
	,
	...
	0x05, 0x52, 0x03, 0x63, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x66, 0x72, 0x6f, 0x6d, 0x4e, 0x66,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x41, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28,
	...
	0x6f, 0x6e, 0x41, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c,
	...
	,
	...
	0x64, 0x69, 0x72, 0x12, 0x40, 0x0a, 0x09, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x52, 0x0a, 0x0c, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73,
	0x73, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x67, 0x61,
	...
	0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x0c, 0x70, 0x72, 0x6f,
	0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xc4, 0x02, 0x0a, 0x0a, 0x48, 0x6f,
	0x6d, 0x65, 0x41, 0x6e, 0x69, 0x6d, 0x61, 0x6c, 0x12, 0x34, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69,
	...
	0x0a, 0x03, 0x64, 0x69, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x67, 0x61,
	0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x56, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x33, 0x52, 0x03, 0x64, 0x69, 0x72, 0x12, 0x4c, 0x0a, 0x0e, 0x61, 0x6e,
	0x69, 0x6d, 0x61, 0x6c, 0x42, 0x61, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01,
	...
	,
	...
	,
...
var file_entity_proto_goTypes = []interface{}{
	...
	(*BTreePhaseProgress)(nil),            // 18: gameMessageCore.BTreePhaseProgress
	(*BTreeData)(nil),                     // 19: gameMessageCore.BTreeData
	(EntityType)(0),                       // 20: gameMessageCore.EntityType
	(*Vector3)(nil),                       // 21: gameMessageCore.Vector3
	(*PlayerBaseData)(nil),                // 22: gameMessageCore.PlayerBaseData
	(*AttributeData)(nil),                 // 23: gameMessageCore.AttributeData
	(*AvatarAttribute)(nil),               // 24: gameMessageCore.AvatarAttribute
	(*CaptureData)(nil),                   // 25: gameMessageCore.CaptureData
	(*CollectResourceProgressResult)(nil), // 26: gameMessageCore.CollectResourceProgressResult
	(*ProxyAnimalBaseData)(nil),           // 27: gameMessageCore.ProxyAnimalBaseData
	(*ProxyAnimalData)(nil),               // 28: gameMessageCore.ProxyAnimalData
}
var file_entity_proto_depIdxs = []int32{
	20, // 0: gameMessageCore.EntityId.type:type_name -> gameMessageCore.EntityType
	21, // 1: gameMessageCore.EntityLocation.loc:type_name -> gameMessageCore.Vector3
	2,  // 2: gameMessageCore.EntityWithLocation.type_id:type_name -> gameMessageCore.EntityId
	14, // 3: gameMessageCore.EntityWithLocation.movement:type_name -> gameMessageCore.EntityMovement
	6,  // 4: gameMessageCore.EntityWithLocation.player:type_name -> gameMessageCore.Player
	7,  // 5: gameMessageCore.EntityWithLocation.monster:type_name -> gameMessageCore.Monster
	9,  // 6: gameMessageCore.EntityWithLocation.build:type_name -> gameMessageCore.NftBuild
	8,  // 7: gameMessageCore.EntityWithLocation.npc:type_name -> gameMessageCore.Npc
	10, // 8: gameMessageCore.EntityWithLocation.resource:type_name -> gameMessageCore.Resource
	11, // 9: gameMessageCore.EntityWithLocation.homeAnimal:type_name -> gameMessageCore.HomeAnimal
	22, // 10: gameMessageCore.Player.base_data:type_name -> gameMessageCore.PlayerBaseData
	23, // 11: gameMessageCore.Player.profile:type_name -> gameMessageCore.AttributeData
	24, // 12: gameMessageCore.Player.avatars:type_name -> gameMessageCore.AvatarAttribute
	21, // 13: gameMessageCore.Player.position:type_name -> gameMessageCore.Vector3
	21, // 14: gameMessageCore.Player.dir:type_name -> gameMessageCore.Vector3
	15, // 15: gameMessageCore.Player.entity_cd:type_name -> gameMessageCore.EntityCD
	25, // 16: gameMessageCore.Player.capture_data:type_name -> gameMessageCore.CaptureData
	23, // 17: gameMessageCore.Monster.profile:type_name -> gameMessageCore.AttributeData
	21, // 18: gameMessageCore.Monster.position:type_name -> gameMessageCore.Vector3
	21, // 19: gameMessageCore.Monster.dir:type_name -> gameMessageCore.Vector3
	25, // 20: gameMessageCore.Monster.capture_data:type_name -> gameMessageCore.CaptureData
	19, // 21: gameMessageCore.Monster.btreeData:type_name -> gameMessageCore.BTreeData
	23, // 22: gameMessageCore.Npc.profile:type_name -> gameMessageCore.AttributeData
	21, // 23: gameMessageCore.Npc.position:type_name -> gameMessageCore.Vector3
	21, // 24: gameMessageCore.Npc.dir:type_name -> gameMessageCore.Vector3
	21, // 25: gameMessageCore.NftBuild.position:type_name -> gameMessageCore.Vector3
	21, // 26: gameMessageCore.NftBuild.dir:type_name -> gameMessageCore.Vector3
	21, // 27: gameMessageCore.Resource.position:type_name -> gameMessageCore.Vector3
	21, // 28: gameMessageCore.Resource.dir:type_name -> gameMessageCore.Vector3
	12, // 29: gameMessageCore.Resource.pointInfo:type_name -> gameMessageCore.ResourcePointInfo
	26, // 30: gameMessageCore.Resource.progressInfo:type_name -> gameMessageCore.CollectResourceProgressResult
	21, // 31: gameMessageCore.HomeAnimal.position:type_name -> gameMessageCore.Vector3
	21, // 32: gameMessageCore.HomeAnimal.dir:type_name -> gameMessageCore.Vector3
	27, // 33: gameMessageCore.HomeAnimal.animalBaseData:type_name -> gameMessageCore.ProxyAnimalBaseData
	28, // 34: gameMessageCore.HomeAnimal.animalDetailData:type_name -> gameMessageCore.ProxyAnimalData
	23, // 35: gameMessageCore.HomeAnimal.profile:type_name -> gameMessageCore.AttributeData
	3,  // 36: gameMessageCore.EntityMoveStep.location:type_name -> gameMessageCore.EntityLocation
	2,  // 37: gameMessageCore.EntityMovement.type_id:type_name -> gameMessageCore.EntityId
	13, // 38: gameMessageCore.EntityMovement.cur_location:type_name -> gameMessageCore.EntityMoveStep
	13, // 39: gameMessageCore.EntityMovement.dest_location:type_name -> gameMessageCore.EntityMoveStep
	0,  // 40: gameMessageCore.EntityMovement.type:type_name -> gameMessageCore.MovementType
	21, // 41: gameMessageCore.EntityMovement.Dir:type_name -> gameMessageCore.Vector3
	16, // 42: gameMessageCore.EntityCD.skill_cd_list:type_name -> gameMessageCore.EntitySkillCD
	17, // 43: gameMessageCore.EntityCD.extend_cd_list:type_name -> gameMessageCore.EntityExtendCD
	18, // 44: gameMessageCore.BTreeData.phaseProgressList:type_name -> gameMessageCore.BTreePhaseProgress
...
func file_entity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_entity_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BTreePhaseProgress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_entity_proto_msgTypes[2].OneofWrappers = []interface{}{
		...
		(*EntityWithLocation_HomeAnimal)(nil),
	}
	type x struct{}
