...
func (x *Resource) GetProfile() *EntityProfile {
	if x != nil {
		return x.Profile
	}
	return nil
...
var file_entity_proto_rawDesc = []byte{
	...
	0x6e, 0x41, 0x74, 0x22, 0xe0, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72,
	0x33, 0x52, 0x03, 0x64, 0x69, 0x72, 0x22, 0x63, 0x0a, 0x0e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79,
...
var file_entity_proto_depIdxs = []int32{
	...
	18, // 22: gameMessageCore.Resource.profile:type_name -> gameMessageCore.EntityProfile
	16, // 23: gameMessageCore.Resource.position:type_name -> gameMessageCore.Vector3
	16, // 24: gameMessageCore.Resource.dir:type_name -> gameMessageCore.Vector3
	...
	10, // 27: gameMessageCore.EntityMovement.cur_location:type_name -> gameMessageCore.EntityMoveStep
	10, // 28: gameMessageCore.EntityMovement.dest_location:type_name -> gameMessageCore.EntityMoveStep
	0,  // 29: gameMessageCore.EntityMovement.type:type_name -> gameMessageCore.MovementType
	16, // 30: gameMessageCore.EntityMovement.Dir:type_name -> gameMessageCore.Vector3
	13, // 31: gameMessageCore.EntityCD.skill_cd_list:type_name -> gameMessageCore.EntitySkillCD
	14, // 32: gameMessageCore.EntityCD.extend_cd_list:type_name -> gameMessageCore.EntityExtendCD
