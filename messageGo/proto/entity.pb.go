...
type HomeAnimal struct {
	...
	Position   *Vector3         `protobuf:"bytes,2,opt,name=position,proto3" json:"position,omitempty"`
	Dir        *Vector3         `protobuf:"bytes,3,opt,name=dir,proto3" json:"dir,omitempty"` // 方向（朝向）
	AnimalData *ProxyAnimalData `protobuf:"bytes,4,opt,name=animalData,proto3" json:"animalData,omitempty"`
}
...
func (x *HomeAnimal) GetCid() int32 {
	if x != nil {
		return x.Cid
	}
	return 0
...
func (x *HomeAnimal) GetAnimalData() *ProxyAnimalData {
	if x != nil {
		return x.AnimalData
	}
	return nil
...
var file_entity_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xc2, 0x01, 0x0a, 0x0a, 0x48, 0x6f, 0x6d, 0x65,
	0x41, 0x6e, 0x69, 0x6d, 0x61, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x03, 0x63, 0x69, 0x64, 0x12, 0x34, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69,
	...
	0x63, 0x74, 0x6f, 0x72, 0x33, 0x52, 0x03, 0x64, 0x69, 0x72, 0x12, 0x40, 0x0a, 0x0a, 0x61, 0x6e,
	0x69, 0x6d, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20,
	0x2e, 0x67, 0x61, 0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65,
	0x2e, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x41, 0x6e, 0x69, 0x6d, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61,
	0x52, 0x0a, 0x61, 0x6e, 0x69, 0x6d, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x22, 0x35, 0x0a, 0x11,
	...
	0x6c, 0x65, 0x10, 0x03, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
...
var file_entity_proto_goTypes = []interface{}{
	...
	(*ProxyAnimalData)(nil),               // 23: gameMessageCore.ProxyAnimalData
}
var file_entity_proto_depIdxs = []int32{
	...
	23, // 29: gameMessageCore.HomeAnimal.animalData:type_name -> gameMessageCore.ProxyAnimalData
	2,  // 30: gameMessageCore.EntityMoveStep.location:type_name -> gameMessageCore.EntityLocation
	1,  // 31: gameMessageCore.EntityMovement.type_id:type_name -> gameMessageCore.EntityId
	12, // 32: gameMessageCore.EntityMovement.cur_location:type_name -> gameMessageCore.EntityMoveStep
	12, // 33: gameMessageCore.EntityMovement.dest_location:type_name -> gameMessageCore.EntityMoveStep
	0,  // 34: gameMessageCore.EntityMovement.type:type_name -> gameMessageCore.MovementType
	18, // 35: gameMessageCore.EntityMovement.Dir:type_name -> gameMessageCore.Vector3
	15, // 36: gameMessageCore.EntityCD.skill_cd_list:type_name -> gameMessageCore.EntitySkillCD
	16, // 37: gameMessageCore.EntityCD.extend_cd_list:type_name -> gameMessageCore.EntityExtendCD
