...
var file_message_body_proto_rawDesc = []byte{
	...
	0x6d, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb0, 0x02, 0x0a, 0x08, 0x45, 0x6e, 0x76,
	...
	0x61, 0x67, 0x65, 0x12, 0x43, 0x0a, 0x0c, 0x70, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x65, 0x71, 0x75,
...
var file_message_body_proto_goTypes = []interface{}{
	...
	(*PingRequest)(nil),  // 1: gameMessageCore.PingRequest
	(*PingResponse)(nil), // 2: gameMessageCore.PingResponse
	(EnvelopeType)(0),    // 3: gameMessageCore.EnvelopeType
}
var file_message_body_proto_depIdxs = []int32{
	3, // 0: gameMessageCore.Envelope.type:type_name -> gameMessageCore.EnvelopeType
	1, // 1: gameMessageCore.Envelope.ping_request:type_name -> gameMessageCore.PingRequest
	2, // 2: gameMessageCore.Envelope.ping_response:type_name -> gameMessageCore.PingResponse
