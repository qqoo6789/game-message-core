...
var file_message_body_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x49, 0x64, 0x73, 0x22, 0x0f, 0x0a, 0x0d, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x42, 0x0a, 0x10, 0x52, 0x65, 0x63, 0x79, 0x63, 0x6c,
	...
	0x76, 0x61, 0x74, 0x61, 0x72, 0x52, 0x07, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x73, 0x22, 0x12,
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x54, 0x61, 0x73, 0x6b,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x0c, 0x74, 0x61, 0x73, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6e,
	0x66, 0x6f, 0x22, 0x82, 0x02, 0x0a, 0x1a, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x54, 0x61,
	0x73, 0x6b, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
...
var file_message_body_proto_depIdxs = []int32{
	...
	100, // 108: gameMessageCore.BroadCastMultiUpLandResponse.lands:type_name -> gameMessageCore.LandData
	101, // 109: gameMessageCore.SelfNftBuildsResponse.builds:type_name -> gameMessageCore.NftBuild
	101, // 110: gameMessageCore.BroadCastSelfBuildUpdateResponse.build:type_name -> gameMessageCore.NftBuild
	102, // 111: gameMessageCore.QueryPlayerResponse.player:type_name -> gameMessageCore.PlayerBaseData
	103, // 112: gameMessageCore.CreatePlayerRequest.feature:type_name -> gameMessageCore.PlayerFeature
	93,  // 113: gameMessageCore.CreatePlayerRequest.os_type:type_name -> gameMessageCore.OSType
	94,  // 114: gameMessageCore.CreatePlayerRequest.platform:type_name -> gameMessageCore.PlatformType
	102, // 115: gameMessageCore.CreatePlayerResponse.player:type_name -> gameMessageCore.PlayerBaseData
	95,  // 116: gameMessageCore.EnterMapResponse.me:type_name -> gameMessageCore.Player
	104, // 117: gameMessageCore.EnterMapResponse.location:type_name -> gameMessageCore.EntityLocation
	105, // 118: gameMessageCore.UpdateSelfLocationRequest.movement:type_name -> gameMessageCore.EntityMovement
	105, // 119: gameMessageCore.UpdateSelfLocationResponse.movement:type_name -> gameMessageCore.EntityMovement
	104, // 120: gameMessageCore.UseSkillRequest.dir:type_name -> gameMessageCore.EntityLocation
	104, // 121: gameMessageCore.UseSkillRequest.from_location:type_name -> gameMessageCore.EntityLocation
	96,  // 122: gameMessageCore.UseSkillRequest.target_id:type_name -> gameMessageCore.EntityId
	106, // 123: gameMessageCore.RespawnPlayerRequest.respawn_point:type_name -> gameMessageCore.PlayerRespawnPoint
	104, // 124: gameMessageCore.RespawnPlayerResponse.location:type_name -> gameMessageCore.EntityLocation
	104, // 125: gameMessageCore.BroadCastRespawnPlayerResponse.location:type_name -> gameMessageCore.EntityLocation
	107, // 126: gameMessageCore.BroadCastInitMapElementResponse.entity:type_name -> gameMessageCore.EntityWithLocation
	107, // 127: gameMessageCore.BroadCastMapEntityUpdateResponse.entity_added:type_name -> gameMessageCore.EntityWithLocation
	96,  // 128: gameMessageCore.BroadCastMapEntityUpdateResponse.entity_removed:type_name -> gameMessageCore.EntityId
	105, // 129: gameMessageCore.BroadCastEntityMoveResponse.moves:type_name -> gameMessageCore.EntityMovement
	96,  // 130: gameMessageCore.BroadCastEntityDestroyResponse.entities:type_name -> gameMessageCore.EntityId
	108, // 131: gameMessageCore.BroadCastEntityCombatResponse.state:type_name -> gameMessageCore.EntityCombatState
	96,  // 132: gameMessageCore.BroadCastEntityCombatResponse.from_entity:type_name -> gameMessageCore.EntityId
	104, // 133: gameMessageCore.BroadCastEntityCombatResponse.dir:type_name -> gameMessageCore.EntityLocation
	104, // 134: gameMessageCore.BroadCastEntityCombatResponse.from_location:type_name -> gameMessageCore.EntityLocation
	109, // 135: gameMessageCore.BroadCastEntityCombatResponse.targets:type_name -> gameMessageCore.EntityDamage
	98,  // 136: gameMessageCore.TeleportRequest.to_pos:type_name -> gameMessageCore.Vector3
	96,  // 137: gameMessageCore.BroadCastEntityAvatarUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	110, // 138: gameMessageCore.BroadCastEntityAvatarUpdateResponse.avatars:type_name -> gameMessageCore.PlayerAvatar
	111, // 139: gameMessageCore.SelfTasksResponse.tasks:type_name -> gameMessageCore.PlayerTask
	112, // 140: gameMessageCore.BroadCastUpdateTaskListResponse.kind:type_name -> gameMessageCore.TaskListType
	113, // 141: gameMessageCore.BroadCastUpdateTaskListResponse.task_list_info:type_name -> gameMessageCore.TaskList
	112, // 142: gameMessageCore.AcceptTaskRequest.kind:type_name -> gameMessageCore.TaskListType
	113, // 143: gameMessageCore.AcceptTaskResponse.task_list_info:type_name -> gameMessageCore.TaskList
	112, // 144: gameMessageCore.AbandonmentTaskRequest.kind:type_name -> gameMessageCore.TaskListType
	113, // 145: gameMessageCore.AbandonmentTaskResponse.task_list_info:type_name -> gameMessageCore.TaskList
	112, // 146: gameMessageCore.TaskRewardRequest.task_list_kind:type_name -> gameMessageCore.TaskListType
	113, // 147: gameMessageCore.TaskRewardResponse.task_list_info:type_name -> gameMessageCore.TaskList
	112, // 148: gameMessageCore.TaskListRewardRequest.kind:type_name -> gameMessageCore.TaskListType
	113, // 149: gameMessageCore.TaskListRewardResponse.task_list_info:type_name -> gameMessageCore.TaskList
	112, // 150: gameMessageCore.UpgradeTaskProgressRequest.task_list_kind:type_name -> gameMessageCore.TaskListType
	114, // 151: gameMessageCore.UpgradeTaskProgressRequest.items:type_name -> gameMessageCore.TaskOptionItem
	115, // 152: gameMessageCore.UpgradeTaskProgressRequest.pos:type_name -> gameMessageCore.TaskOptionMoveTo
	116, // 153: gameMessageCore.UpgradeTaskProgressRequest.quiz:type_name -> gameMessageCore.TaskOptionQuiz
	112, // 154: gameMessageCore.BroadCastTaskRewardResponse.task_list_kind:type_name -> gameMessageCore.TaskListType
	99,  // 155: gameMessageCore.BroadCastTaskRewardResponse.reward_item:type_name -> gameMessageCore.ItemBaseInfo
	117, // 156: gameMessageCore.SendChatMessageRequest.chat_type:type_name -> gameMessageCore.ChatChannelType
	118, // 157: gameMessageCore.BroadCastChatMessagesResponse.messages:type_name -> gameMessageCore.ChatMessage
	119, // 158: gameMessageCore.BroadCastUpdateChatStateResponse.chat_state:type_name -> gameMessageCore.ChatState
