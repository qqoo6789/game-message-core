...
var file_message_body_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x64, 0x0a, 0x08, 0x45, 0x6e, 0x76,
...
var file_message_body_proto_msgTypes = make([]protoimpl.MessageInfo, 121)
var file_message_body_proto_goTypes = []interface{}{
	...
	(EnvelopeType)(0),                               // 121: gameMessageCore.EnvelopeType
	(TickOutType)(0),                                // 122: gameMessageCore.TickOutType
	(*Item)(nil),                                    // 123: gameMessageCore.Item
	(*ItemSlot)(nil),                                // 124: gameMessageCore.ItemSlot
	(AvatarPosition)(0),                             // 125: gameMessageCore.AvatarPosition
	(OSType)(0),                                     // 126: gameMessageCore.OSType
	(PlatformType)(0),                               // 127: gameMessageCore.PlatformType
	(*Player)(nil),                                  // 128: gameMessageCore.Player
	(*EntityId)(nil),                                // 129: gameMessageCore.EntityId
	(*AttributeData)(nil),                           // 130: gameMessageCore.AttributeData
	(*Vector3)(nil),                                 // 131: gameMessageCore.Vector3
	(*ItemBaseInfo)(nil),                            // 132: gameMessageCore.ItemBaseInfo
	(*LandData)(nil),                                // 133: gameMessageCore.LandData
	(*NftBuild)(nil),                                // 134: gameMessageCore.NftBuild
	(TalentType)(0),                                 // 135: gameMessageCore.TalentType
	(*TalentExp)(nil),                               // 136: gameMessageCore.TalentExp
	(*PlayerBaseData)(nil),                          // 137: gameMessageCore.PlayerBaseData
	(*PlayerFeature)(nil),                           // 138: gameMessageCore.PlayerFeature
	(*EntityLocation)(nil),                          // 139: gameMessageCore.EntityLocation
	(*EntityMovement)(nil),                          // 140: gameMessageCore.EntityMovement
	(*UseCollectResourceSkillInfo)(nil),             // 141: gameMessageCore.UseCollectResourceSkillInfo
	(PlayerRespawnPoint)(0),                         // 142: gameMessageCore.PlayerRespawnPoint
	(*ProxySoilData)(nil),                           // 143: gameMessageCore.ProxySoilData
	(*HomeSoilProgressInfo)(nil),                    // 144: gameMessageCore.HomeSoilProgressInfo
	...
	(*AvatarAttribute)(nil),                         // 151: gameMessageCore.AvatarAttribute
...
var file_message_body_proto_depIdxs = []int32{
	121, // 0: gameMessageCore.Envelope.type:type_name -> gameMessageCore.EnvelopeType
	...
	122, // 121: gameMessageCore.BroadCastTickOutResponse.kind:type_name -> gameMessageCore.TickOutType
	123, // 122: gameMessageCore.BroadCastInitItemResponse.items:type_name -> gameMessageCore.Item
	123, // 123: gameMessageCore.BroadCastItemAddResponse.items:type_name -> gameMessageCore.Item
	123, // 124: gameMessageCore.BroadCastItemUpdateResponse.items:type_name -> gameMessageCore.Item
	123, // 125: gameMessageCore.BroadCastItemDelResponse.items:type_name -> gameMessageCore.Item
	124, // 126: gameMessageCore.BroadCastUpdateItemSlotResponse.slots:type_name -> gameMessageCore.ItemSlot
	124, // 127: gameMessageCore.GetItemSlotResponse.slots:type_name -> gameMessageCore.ItemSlot
	125, // 128: gameMessageCore.UpgradeItemSlotRequest.position:type_name -> gameMessageCore.AvatarPosition
	124, // 129: gameMessageCore.UpgradeItemSlotResponse.slots:type_name -> gameMessageCore.ItemSlot
	126, // 130: gameMessageCore.SigninPlayerRequest.os_type:type_name -> gameMessageCore.OSType
	127, // 131: gameMessageCore.SigninPlayerRequest.platform:type_name -> gameMessageCore.PlatformType
	128, // 132: gameMessageCore.SigninPlayerResponse.player:type_name -> gameMessageCore.Player
	129, // 133: gameMessageCore.BroadCastEntityProfileUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	130, // 134: gameMessageCore.BroadCastEntityProfileUpdateResponse.profiles:type_name -> gameMessageCore.AttributeData
	131, // 135: gameMessageCore.BroadCastMonsterDeathResponse.pos:type_name -> gameMessageCore.Vector3
	132, // 136: gameMessageCore.BroadCastMonsterDeathResponse.drop_list:type_name -> gameMessageCore.ItemBaseInfo
	129, // 137: gameMessageCore.BroadCastEntityBattleDataUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	133, // 138: gameMessageCore.BroadCastInitLandResponse.lands:type_name -> gameMessageCore.LandData
	131, // 139: gameMessageCore.BuildRequest.position:type_name -> gameMessageCore.Vector3
	134, // 140: gameMessageCore.BuildResponse.build:type_name -> gameMessageCore.NftBuild
	133, // 141: gameMessageCore.BroadCastMultiUpLandResponse.lands:type_name -> gameMessageCore.LandData
	134, // 142: gameMessageCore.SelfNftBuildsResponse.builds:type_name -> gameMessageCore.NftBuild
	134, // 143: gameMessageCore.BroadCastSelfBuildUpdateResponse.build:type_name -> gameMessageCore.NftBuild
	132, // 144: gameMessageCore.QueryGranaryResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	132, // 145: gameMessageCore.GranaryCollectResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	132, // 146: gameMessageCore.BroadCastGranaryUpdateResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	132, // 147: gameMessageCore.BroadCastUpGranaryItemResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	135, // 148: gameMessageCore.UpgradeTalentNodeRequest.type:type_name -> gameMessageCore.TalentType
	136, // 149: gameMessageCore.QueryTalentExpResponse.expData:type_name -> gameMessageCore.TalentExp
	136, // 150: gameMessageCore.BroadCastUpTalentExpResponse.updateExps:type_name -> gameMessageCore.TalentExp
	137, // 151: gameMessageCore.QueryPlayerResponse.player:type_name -> gameMessageCore.PlayerBaseData
	138, // 152: gameMessageCore.CreatePlayerRequest.feature:type_name -> gameMessageCore.PlayerFeature
	126, // 153: gameMessageCore.CreatePlayerRequest.os_type:type_name -> gameMessageCore.OSType
	127, // 154: gameMessageCore.CreatePlayerRequest.platform:type_name -> gameMessageCore.PlatformType
	137, // 155: gameMessageCore.CreatePlayerResponse.player:type_name -> gameMessageCore.PlayerBaseData
	128, // 156: gameMessageCore.EnterMapResponse.me:type_name -> gameMessageCore.Player
	139, // 157: gameMessageCore.EnterMapResponse.location:type_name -> gameMessageCore.EntityLocation
	140, // 158: gameMessageCore.UpdateSelfLocationRequest.movement:type_name -> gameMessageCore.EntityMovement
	140, // 159: gameMessageCore.UpdateSelfLocationResponse.movement:type_name -> gameMessageCore.EntityMovement
	139, // 160: gameMessageCore.UseSkillRequest.dir:type_name -> gameMessageCore.EntityLocation
	139, // 161: gameMessageCore.UseSkillRequest.from_location:type_name -> gameMessageCore.EntityLocation
	129, // 162: gameMessageCore.UseSkillRequest.target_id:type_name -> gameMessageCore.EntityId
	141, // 163: gameMessageCore.UseSkillRequest.homeCollectInfo:type_name -> gameMessageCore.UseCollectResourceSkillInfo
	142, // 164: gameMessageCore.RespawnPlayerRequest.respawn_point:type_name -> gameMessageCore.PlayerRespawnPoint
	139, // 165: gameMessageCore.RespawnPlayerResponse.location:type_name -> gameMessageCore.EntityLocation
	139, // 166: gameMessageCore.BroadCastRespawnPlayerResponse.location:type_name -> gameMessageCore.EntityLocation
	143, // 167: gameMessageCore.BroadCastHomeDataInitBatchResponse.soilDataList:type_name -> gameMessageCore.ProxySoilData
	144, // 168: gameMessageCore.BroadCastHomeDataInitBatchResponse.soilProgressList:type_name -> gameMessageCore.HomeSoilProgressInfo
	145, // 169: gameMessageCore.BroadCastHomeSkillResultResponse.operateResultList:type_name -> gameMessageCore.CollectResourceOperateResult
	...
	129, // 173: gameMessageCore.BroadCastMapEntityUpdateResponse.entity_removed:type_name -> gameMessageCore.EntityId
	...
	140, // 175: gameMessageCore.BroadCastEntityMoveResponse.moves:type_name -> gameMessageCore.EntityMovement
	129, // 176: gameMessageCore.BroadCastEntityDestroyResponse.entities:type_name -> gameMessageCore.EntityId
	148, // 177: gameMessageCore.BroadCastEntityCombatResponse.state:type_name -> gameMessageCore.EntityCombatState
	129, // 178: gameMessageCore.BroadCastEntityCombatResponse.from_entity:type_name -> gameMessageCore.EntityId
	139, // 179: gameMessageCore.BroadCastEntityCombatResponse.dir:type_name -> gameMessageCore.EntityLocation
	139, // 180: gameMessageCore.BroadCastEntityCombatResponse.from_location:type_name -> gameMessageCore.EntityLocation
	...
	131, // 183: gameMessageCore.TeleportRequest.to_pos:type_name -> gameMessageCore.Vector3
	129, // 184: gameMessageCore.BroadCastEntityAvatarUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	151, // 185: gameMessageCore.BroadCastEntityAvatarUpdateResponse.avatars:type_name -> gameMessageCore.AvatarAttribute
	129, // 186: gameMessageCore.BroadCastEntityBuildDataUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	...
	132, // 211: gameMessageCore.BroadCastTaskRewardResponse.reward_item:type_name -> gameMessageCore.ItemBaseInfo
