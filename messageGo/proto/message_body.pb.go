...
var file_message_body_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdd, 0x65, 0x0a, 0x08, 0x45, 0x6e, 0x76,
	...
	0x4c, 0x69, 0x73, 0x74, 0x22, 0x81, 0x01, 0x0a, 0x27, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x43, 0x61,
	...
	0x49, 0x6e, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72,
...
var file_message_body_proto_msgTypes = make([]protoimpl.MessageInfo, 122)
var file_message_body_proto_goTypes = []interface{}{
	...
	(*BroadCastUpdateTaskListResponse)(nil),         // 102: gameMessageCore.BroadCastUpdateTaskListResponse
	(*AcceptTaskRequest)(nil),                       // 103: gameMessageCore.AcceptTaskRequest
	(*AcceptTaskResponse)(nil),                      // 104: gameMessageCore.AcceptTaskResponse
	(*AbandonmentTaskRequest)(nil),                  // 105: gameMessageCore.AbandonmentTaskRequest
	(*AbandonmentTaskResponse)(nil),                 // 106: gameMessageCore.AbandonmentTaskResponse
	(*TaskRewardRequest)(nil),                       // 107: gameMessageCore.TaskRewardRequest
	(*TaskRewardResponse)(nil),                      // 108: gameMessageCore.TaskRewardResponse
	(*TaskListRewardRequest)(nil),                   // 109: gameMessageCore.TaskListRewardRequest
	(*TaskListRewardResponse)(nil),                  // 110: gameMessageCore.TaskListRewardResponse
	(*UpgradeTaskProgressRequest)(nil),              // 111: gameMessageCore.UpgradeTaskProgressRequest
	(*UpgradeTaskProgressResponse)(nil),             // 112: gameMessageCore.UpgradeTaskProgressResponse
	(*BroadCastTaskRewardResponse)(nil),             // 113: gameMessageCore.BroadCastTaskRewardResponse
	(*SendChatMessageRequest)(nil),                  // 114: gameMessageCore.SendChatMessageRequest
	(*SendChatMessageResponse)(nil),                 // 115: gameMessageCore.SendChatMessageResponse
	(*BroadCastChatMessagesResponse)(nil),           // 116: gameMessageCore.BroadCastChatMessagesResponse
	(*BroadCastRemoveChatMessageResponse)(nil),      // 117: gameMessageCore.BroadCastRemoveChatMessageResponse
	(*BroadCastUpdateChatStateResponse)(nil),        // 118: gameMessageCore.BroadCastUpdateChatStateResponse
	(*PingRequest)(nil),                             // 119: gameMessageCore.PingRequest
	(*PingResponse)(nil),                            // 120: gameMessageCore.PingResponse
	(*BroadCastMsgAggregationResponse)(nil),         // 121: gameMessageCore.BroadCastMsgAggregationResponse
	(EnvelopeType)(0),                               // 122: gameMessageCore.EnvelopeType
	(TickOutType)(0),                                // 123: gameMessageCore.TickOutType
	(*Item)(nil),                                    // 124: gameMessageCore.Item
	(*ItemSlot)(nil),                                // 125: gameMessageCore.ItemSlot
	(AvatarPosition)(0),                             // 126: gameMessageCore.AvatarPosition
	(OSType)(0),                                     // 127: gameMessageCore.OSType
	(PlatformType)(0),                               // 128: gameMessageCore.PlatformType
	(*Player)(nil),                                  // 129: gameMessageCore.Player
	(*EntityId)(nil),                                // 130: gameMessageCore.EntityId
	(*AttributeData)(nil),                           // 131: gameMessageCore.AttributeData
	(*Vector3)(nil),                                 // 132: gameMessageCore.Vector3
	(*ItemBaseInfo)(nil),                            // 133: gameMessageCore.ItemBaseInfo
	(*LandData)(nil),                                // 134: gameMessageCore.LandData
	(*NftBuild)(nil),                                // 135: gameMessageCore.NftBuild
	(TalentType)(0),                                 // 136: gameMessageCore.TalentType
	(*TalentExp)(nil),                               // 137: gameMessageCore.TalentExp
	(*PlayerBaseData)(nil),                          // 138: gameMessageCore.PlayerBaseData
	(*PlayerFeature)(nil),                           // 139: gameMessageCore.PlayerFeature
	(*EntityLocation)(nil),                          // 140: gameMessageCore.EntityLocation
	(*EntityMovement)(nil),                          // 141: gameMessageCore.EntityMovement
	(*UseCollectResourceSkillInfo)(nil),             // 142: gameMessageCore.UseCollectResourceSkillInfo
	(PlayerRespawnPoint)(0),                         // 143: gameMessageCore.PlayerRespawnPoint
	(*ProxySoilData)(nil),                           // 144: gameMessageCore.ProxySoilData
	(*HomeSoilProgressInfo)(nil),                    // 145: gameMessageCore.HomeSoilProgressInfo
	(*CollectResourceOperateResult)(nil),            // 146: gameMessageCore.CollectResourceOperateResult
	(*EntityWithLocation)(nil),                      // 147: gameMessageCore.EntityWithLocation
	(*DestructionElementData)(nil),                  // 148: gameMessageCore.DestructionElementData
	(EntityCombatState)(0),                          // 149: gameMessageCore.EntityCombatState
	(*EntityDamage)(nil),                            // 150: gameMessageCore.EntityDamage
	(*SkillFlyerData)(nil),                          // 151: gameMessageCore.SkillFlyerData
	(*AvatarAttribute)(nil),                         // 152: gameMessageCore.AvatarAttribute
	(ServiceType)(0),                                // 153: gameMessageCore.ServiceType
	(SceneServiceSubType)(0),                        // 154: gameMessageCore.SceneServiceSubType
	(*TalentLevel)(nil),                             // 155: gameMessageCore.TalentLevel
	(*TalentTree)(nil),                              // 156: gameMessageCore.TalentTree
	(*TalentTreeUpdate)(nil),                        // 157: gameMessageCore.TalentTreeUpdate
...
var file_message_body_proto_depIdxs = []int32{
	122, // 0: gameMessageCore.Envelope.type:type_name -> gameMessageCore.EnvelopeType
	...
	102, // 102: gameMessageCore.Envelope.broad_cast_update_task_list_response:type_name -> gameMessageCore.BroadCastUpdateTaskListResponse
	103, // 103: gameMessageCore.Envelope.accept_task_request:type_name -> gameMessageCore.AcceptTaskRequest
	104, // 104: gameMessageCore.Envelope.accept_task_response:type_name -> gameMessageCore.AcceptTaskResponse
	105, // 105: gameMessageCore.Envelope.abandonment_task_request:type_name -> gameMessageCore.AbandonmentTaskRequest
	106, // 106: gameMessageCore.Envelope.abandonment_task_response:type_name -> gameMessageCore.AbandonmentTaskResponse
	107, // 107: gameMessageCore.Envelope.task_reward_request:type_name -> gameMessageCore.TaskRewardRequest
	108, // 108: gameMessageCore.Envelope.task_reward_response:type_name -> gameMessageCore.TaskRewardResponse
	109, // 109: gameMessageCore.Envelope.task_list_reward_request:type_name -> gameMessageCore.TaskListRewardRequest
	110, // 110: gameMessageCore.Envelope.task_list_reward_response:type_name -> gameMessageCore.TaskListRewardResponse
	111, // 111: gameMessageCore.Envelope.upgrade_task_progress_request:type_name -> gameMessageCore.UpgradeTaskProgressRequest
	112, // 112: gameMessageCore.Envelope.upgrade_task_progress_response:type_name -> gameMessageCore.UpgradeTaskProgressResponse
	113, // 113: gameMessageCore.Envelope.broad_cast_task_reward_response:type_name -> gameMessageCore.BroadCastTaskRewardResponse
	114, // 114: gameMessageCore.Envelope.send_chat_message_request:type_name -> gameMessageCore.SendChatMessageRequest
	115, // 115: gameMessageCore.Envelope.send_chat_message_response:type_name -> gameMessageCore.SendChatMessageResponse
	116, // 116: gameMessageCore.Envelope.broad_cast_chat_messages_response:type_name -> gameMessageCore.BroadCastChatMessagesResponse
	117, // 117: gameMessageCore.Envelope.broad_cast_remove_chat_message_response:type_name -> gameMessageCore.BroadCastRemoveChatMessageResponse
	118, // 118: gameMessageCore.Envelope.broad_cast_update_chat_state_response:type_name -> gameMessageCore.BroadCastUpdateChatStateResponse
	119, // 119: gameMessageCore.Envelope.ping_request:type_name -> gameMessageCore.PingRequest
	120, // 120: gameMessageCore.Envelope.ping_response:type_name -> gameMessageCore.PingResponse
	121, // 121: gameMessageCore.Envelope.broadCast_msg_aggregation_response:type_name -> gameMessageCore.BroadCastMsgAggregationResponse
	123, // 122: gameMessageCore.BroadCastTickOutResponse.kind:type_name -> gameMessageCore.TickOutType
	124, // 123: gameMessageCore.BroadCastInitItemResponse.items:type_name -> gameMessageCore.Item
	124, // 124: gameMessageCore.BroadCastItemAddResponse.items:type_name -> gameMessageCore.Item
	124, // 125: gameMessageCore.BroadCastItemUpdateResponse.items:type_name -> gameMessageCore.Item
	124, // 126: gameMessageCore.BroadCastItemDelResponse.items:type_name -> gameMessageCore.Item
	125, // 127: gameMessageCore.BroadCastUpdateItemSlotResponse.slots:type_name -> gameMessageCore.ItemSlot
	125, // 128: gameMessageCore.GetItemSlotResponse.slots:type_name -> gameMessageCore.ItemSlot
	126, // 129: gameMessageCore.UpgradeItemSlotRequest.position:type_name -> gameMessageCore.AvatarPosition
	125, // 130: gameMessageCore.UpgradeItemSlotResponse.slots:type_name -> gameMessageCore.ItemSlot
	127, // 131: gameMessageCore.SigninPlayerRequest.os_type:type_name -> gameMessageCore.OSType
	128, // 132: gameMessageCore.SigninPlayerRequest.platform:type_name -> gameMessageCore.PlatformType
	129, // 133: gameMessageCore.SigninPlayerResponse.player:type_name -> gameMessageCore.Player
	130, // 134: gameMessageCore.BroadCastEntityProfileUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	131, // 135: gameMessageCore.BroadCastEntityProfileUpdateResponse.profiles:type_name -> gameMessageCore.AttributeData
	132, // 136: gameMessageCore.BroadCastMonsterDeathResponse.pos:type_name -> gameMessageCore.Vector3
	133, // 137: gameMessageCore.BroadCastMonsterDeathResponse.drop_list:type_name -> gameMessageCore.ItemBaseInfo
	130, // 138: gameMessageCore.BroadCastEntityBattleDataUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	134, // 139: gameMessageCore.BroadCastInitLandResponse.lands:type_name -> gameMessageCore.LandData
	132, // 140: gameMessageCore.BuildRequest.position:type_name -> gameMessageCore.Vector3
	135, // 141: gameMessageCore.BuildResponse.build:type_name -> gameMessageCore.NftBuild
	134, // 142: gameMessageCore.BroadCastMultiUpLandResponse.lands:type_name -> gameMessageCore.LandData
	135, // 143: gameMessageCore.SelfNftBuildsResponse.builds:type_name -> gameMessageCore.NftBuild
	135, // 144: gameMessageCore.BroadCastSelfBuildUpdateResponse.build:type_name -> gameMessageCore.NftBuild
	133, // 145: gameMessageCore.QueryGranaryResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	133, // 146: gameMessageCore.GranaryCollectResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	133, // 147: gameMessageCore.BroadCastGranaryUpdateResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	133, // 148: gameMessageCore.BroadCastUpGranaryItemResponse.items:type_name -> gameMessageCore.ItemBaseInfo
	136, // 149: gameMessageCore.UpgradeTalentNodeRequest.type:type_name -> gameMessageCore.TalentType
	137, // 150: gameMessageCore.QueryTalentExpResponse.expData:type_name -> gameMessageCore.TalentExp
	137, // 151: gameMessageCore.BroadCastUpTalentExpResponse.updateExps:type_name -> gameMessageCore.TalentExp
	138, // 152: gameMessageCore.QueryPlayerResponse.player:type_name -> gameMessageCore.PlayerBaseData
	139, // 153: gameMessageCore.CreatePlayerRequest.feature:type_name -> gameMessageCore.PlayerFeature
	127, // 154: gameMessageCore.CreatePlayerRequest.os_type:type_name -> gameMessageCore.OSType
	128, // 155: gameMessageCore.CreatePlayerRequest.platform:type_name -> gameMessageCore.PlatformType
	138, // 156: gameMessageCore.CreatePlayerResponse.player:type_name -> gameMessageCore.PlayerBaseData
	129, // 157: gameMessageCore.EnterMapResponse.me:type_name -> gameMessageCore.Player
	140, // 158: gameMessageCore.EnterMapResponse.location:type_name -> gameMessageCore.EntityLocation
	141, // 159: gameMessageCore.UpdateSelfLocationRequest.movement:type_name -> gameMessageCore.EntityMovement
	141, // 160: gameMessageCore.UpdateSelfLocationResponse.movement:type_name -> gameMessageCore.EntityMovement
	140, // 161: gameMessageCore.UseSkillRequest.dir:type_name -> gameMessageCore.EntityLocation
	140, // 162: gameMessageCore.UseSkillRequest.from_location:type_name -> gameMessageCore.EntityLocation
	130, // 163: gameMessageCore.UseSkillRequest.target_id:type_name -> gameMessageCore.EntityId
	142, // 164: gameMessageCore.UseSkillRequest.homeCollectInfo:type_name -> gameMessageCore.UseCollectResourceSkillInfo
	143, // 165: gameMessageCore.RespawnPlayerRequest.respawn_point:type_name -> gameMessageCore.PlayerRespawnPoint
	140, // 166: gameMessageCore.RespawnPlayerResponse.location:type_name -> gameMessageCore.EntityLocation
	140, // 167: gameMessageCore.BroadCastRespawnPlayerResponse.location:type_name -> gameMessageCore.EntityLocation
	144, // 168: gameMessageCore.BroadCastHomeDataInitBatchResponse.soilDataList:type_name -> gameMessageCore.ProxySoilData
	145, // 169: gameMessageCore.BroadCastHomeDataInitBatchResponse.soilProgressList:type_name -> gameMessageCore.HomeSoilProgressInfo
	146, // 170: gameMessageCore.BroadCastHomeSkillResultResponse.operateResultList:type_name -> gameMessageCore.CollectResourceOperateResult
	147, // 171: gameMessageCore.BroadCastInitMapElementResponse.entity:type_name -> gameMessageCore.EntityWithLocation
	148, // 172: gameMessageCore.BroadCastInitMapElementResponse.destruction_elements:type_name -> gameMessageCore.DestructionElementData
	147, // 173: gameMessageCore.BroadCastMapEntityUpdateResponse.entity_added:type_name -> gameMessageCore.EntityWithLocation
	130, // 174: gameMessageCore.BroadCastMapEntityUpdateResponse.entity_removed:type_name -> gameMessageCore.EntityId
	148, // 175: gameMessageCore.BroadCastMapEntityUpdateResponse.destruction_elements:type_name -> gameMessageCore.DestructionElementData
	141, // 176: gameMessageCore.BroadCastEntityMoveResponse.moves:type_name -> gameMessageCore.EntityMovement
	130, // 177: gameMessageCore.BroadCastEntityDestroyResponse.entities:type_name -> gameMessageCore.EntityId
	149, // 178: gameMessageCore.BroadCastEntityCombatResponse.state:type_name -> gameMessageCore.EntityCombatState
	130, // 179: gameMessageCore.BroadCastEntityCombatResponse.from_entity:type_name -> gameMessageCore.EntityId
	140, // 180: gameMessageCore.BroadCastEntityCombatResponse.dir:type_name -> gameMessageCore.EntityLocation
	140, // 181: gameMessageCore.BroadCastEntityCombatResponse.from_location:type_name -> gameMessageCore.EntityLocation
	150, // 182: gameMessageCore.BroadCastEntityCombatResponse.targets:type_name -> gameMessageCore.EntityDamage
	151, // 183: gameMessageCore.BroadCastEntityCombatResponse.flyers:type_name -> gameMessageCore.SkillFlyerData
	132, // 184: gameMessageCore.TeleportRequest.to_pos:type_name -> gameMessageCore.Vector3
	130, // 185: gameMessageCore.BroadCastEntityAvatarUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	152, // 186: gameMessageCore.BroadCastEntityAvatarUpdateResponse.avatars:type_name -> gameMessageCore.AvatarAttribute
	130, // 187: gameMessageCore.BroadCastEntityBuildDataUpdateResponse.entity_id:type_name -> gameMessageCore.EntityId
	148, // 188: gameMessageCore.BroadCastSceneDestructionResponse.destruction_elements:type_name -> gameMessageCore.DestructionElementData
	153, // 189: gameMessageCore.BroadCastChangeServiceResponse.serType:type_name -> gameMessageCore.ServiceType
	154, // 190: gameMessageCore.BroadCastChangeServiceResponse.serSubType:type_name -> gameMessageCore.SceneServiceSubType
	155, // 191: gameMessageCore.QueryTalentTreeResponse.levelData:type_name -> gameMessageCore.TalentLevel
	156, // 192: gameMessageCore.QueryTalentTreeResponse.tree:type_name -> gameMessageCore.TalentTree
	155, // 193: gameMessageCore.BroadCastTalentTreeUpdateResponse.levelData:type_name -> gameMessageCore.TalentLevel
	157, // 194: gameMessageCore.BroadCastTalentTreeUpdateResponse.upTrees:type_name -> gameMessageCore.TalentTreeUpdate
	158, // 195: gameMessageCore.SelfTasksResponse.tasks:type_name -> gameMessageCore.PlayerTask
	159, // 196: gameMessageCore.BroadCastUpdateTaskListResponse.kind:type_name -> gameMessageCore.TaskListType
	160, // 197: gameMessageCore.BroadCastUpdateTaskListResponse.task_list_info:type_name -> gameMessageCore.TaskList
	159, // 198: gameMessageCore.AcceptTaskRequest.kind:type_name -> gameMessageCore.TaskListType
	160, // 199: gameMessageCore.AcceptTaskResponse.task_list_info:type_name -> gameMessageCore.TaskList
	159, // 200: gameMessageCore.AbandonmentTaskRequest.kind:type_name -> gameMessageCore.TaskListType
	160, // 201: gameMessageCore.AbandonmentTaskResponse.task_list_info:type_name -> gameMessageCore.TaskList
	159, // 202: gameMessageCore.TaskRewardRequest.task_list_kind:type_name -> gameMessageCore.TaskListType
	160, // 203: gameMessageCore.TaskRewardResponse.task_list_info:type_name -> gameMessageCore.TaskList
	159, // 204: gameMessageCore.TaskListRewardRequest.kind:type_name -> gameMessageCore.TaskListType
	160, // 205: gameMessageCore.TaskListRewardResponse.task_list_info:type_name -> gameMessageCore.TaskList
	159, // 206: gameMessageCore.UpgradeTaskProgressRequest.task_list_kind:type_name -> gameMessageCore.TaskListType
	161, // 207: gameMessageCore.UpgradeTaskProgressRequest.items:type_name -> gameMessageCore.TaskOptionItem
	162, // 208: gameMessageCore.UpgradeTaskProgressRequest.pos:type_name -> gameMessageCore.TaskOptionTargetPosition
	163, // 209: gameMessageCore.UpgradeTaskProgressRequest.useRecipe:type_name -> gameMessageCore.TaskOptionUseRecipe
	164, // 210: gameMessageCore.UpgradeTaskProgressRequest.craftSkillLevel:type_name -> gameMessageCore.TaskOptionCraftSkillLevel
	159, // 211: gameMessageCore.BroadCastTaskRewardResponse.task_list_kind:type_name -> gameMessageCore.TaskListType
	133, // 212: gameMessageCore.BroadCastTaskRewardResponse.reward_item:type_name -> gameMessageCore.ItemBaseInfo
	165, // 213: gameMessageCore.SendChatMessageRequest.chat_type:type_name -> gameMessageCore.ChatChannelType
	166, // 214: gameMessageCore.BroadCastChatMessagesResponse.messages:type_name -> gameMessageCore.ChatMessage
	167, // 215: gameMessageCore.BroadCastUpdateChatStateResponse.chat_state:type_name -> gameMessageCore.ChatState
	0,   // 216: gameMessageCore.BroadCastMsgAggregationResponse.message_list:type_name -> gameMessageCore.Envelope
