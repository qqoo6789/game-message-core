...
var file_player_proto_rawDesc = []byte{
	...
	0x6f, 0x69, 0x6e, 0x74, 0x41, 0x72, 0x65, 0x61, 0x10, 0x02, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f,
...
var file_player_proto_goTypes = []interface{}{
	...
	(*PlayerFeature)(nil),   // 1: gameMessageCore.PlayerFeature
	(*PlayerBaseData)(nil),  // 2: gameMessageCore.PlayerBaseData
}
var file_player_proto_depIdxs = []int32{
	1, // 0: gameMessageCore.PlayerBaseData.feature:type_name -> gameMessageCore.PlayerFeature
