...
const (
	TalentType_TalentTypeUnknown TalentType = 0
	// 农业种植
	TalentType_Farming TalentType = 1
	// 战斗
	TalentType_Battle TalentType = 2
	// 采集|收集
	TalentType_Gather TalentType = 3
)
...
// 天赋收益
type TalentGainsType int32

const (
	// 获得主动技能
	TalentGainsType_ActiveSkill TalentGainsType = 0
	// 获得被动技能
	TalentGainsType_PassiveSkill TalentGainsType = 1
	// 获得合成配方
	TalentGainsType_Recipes TalentGainsType = 2
)

// Enum value maps for TalentGainsType.
var (
	TalentGainsType_name = map[int32]string{
		0: "ActiveSkill",
		1: "PassiveSkill",
		2: "Recipes",
	}
	TalentGainsType_value = map[string]int32{
		"ActiveSkill":  0,
		"PassiveSkill": 1,
		"Recipes":      2,
	}
...
func (x TalentGainsType) Enum() *TalentGainsType {
	p := new(TalentGainsType)
	*p = x
	return p
}

func (x TalentGainsType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TalentGainsType) Descriptor() protoreflect.EnumDescriptor {
	return file_talent_proto_enumTypes[1].Descriptor()
}

func (TalentGainsType) Type() protoreflect.EnumType {
	return &file_talent_proto_enumTypes[1]
}

func (x TalentGainsType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TalentGainsType.Descriptor instead.
func (TalentGainsType) EnumDescriptor() ([]byte, []int) {
...
type TalentLevel struct {
	...
	MasterLevel int32      `protobuf:"varint,3,opt,name=masterLevel,proto3" json:"masterLevel,omitempty"`
}
...
func (x *TalentLevel) GetMasterLevel() int32 {
	if x != nil {
...
type TalentTreeUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type        TalentType    `protobuf:"varint,1,opt,name=type,proto3,enum=gameMessageCore.TalentType" json:"type,omitempty"`
	AddNodes    []*TalentNode `protobuf:"bytes,2,rep,name=addNodes,proto3" json:"addNodes,omitempty"`
	UpdateNodes []*TalentNode `protobuf:"bytes,3,rep,name=updateNodes,proto3" json:"updateNodes,omitempty"`
	RemoveNodes []int32       `protobuf:"varint,4,rep,packed,name=removeNodes,proto3" json:"removeNodes,omitempty"`
}

func (x *TalentTreeUpdate) Reset() {
	*x = TalentTreeUpdate{}
	if protoimpl.UnsafeEnabled {
...
func (x *TalentTreeUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TalentTreeUpdate) ProtoMessage() {}

func (x *TalentTreeUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_talent_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TalentTreeUpdate.ProtoReflect.Descriptor instead.
func (*TalentTreeUpdate) Descriptor() ([]byte, []int) {
	return file_talent_proto_rawDescGZIP(), []int{5}
}

func (x *TalentTreeUpdate) GetType() TalentType {
	if x != nil {
		return x.Type
	}
	return TalentType_TalentTypeUnknown
...
func (x *TalentTreeUpdate) GetAddNodes() []*TalentNode {
	if x != nil {
		return x.AddNodes
	}
	return nil
...
func (x *TalentTreeUpdate) GetUpdateNodes() []*TalentNode {
	if x != nil {
...
func (x *TalentTreeUpdate) GetRemoveNodes() []int32 {
	if x != nil {
...
var file_talent_proto_rawDesc = []byte{
	...
	0x70, 0x22, 0x76, 0x0a, 0x0b, 0x54, 0x61, 0x6c, 0x65, 0x6e, 0x74, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	...
	0x52, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x20, 0x0a, 0x0b, 0x6d, 0x61, 0x73, 0x74, 0x65,
	0x72, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x6d, 0x61,
	0x73, 0x74, 0x65, 0x72, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x3a, 0x0a, 0x0a, 0x54, 0x61, 0x6c,
	0x65, 0x6e, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x6f, 0x64, 0x65, 0x49,
	...
	0x6c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x7c, 0x0a, 0x0a, 0x54, 0x61, 0x6c, 0x65, 0x6e, 0x74, 0x54,
	0x72, 0x65, 0x65, 0x12, 0x2f, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x74, 0x79, 0x70, 0x65, 0x12, 0x3d, 0x0a, 0x0b, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x6f,
	0x64, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x61, 0x6d, 0x65,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x72, 0x65, 0x2e, 0x54, 0x61, 0x6c, 0x65,
	0x6e, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x0b, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x6f,
	0x64, 0x65, 0x73, 0x22, 0xaf, 0x01, 0x0a, 0x0a, 0x54, 0x61, 0x6c, 0x65, 0x6e, 0x74, 0x44, 0x61,
	0x74, 0x61, 0x12, 0x34, 0x0a, 0x07, 0x65, 0x78, 0x70, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20,
	...
	0x07, 0x65, 0x78, 0x70, 0x44, 0x61, 0x74, 0x61, 0x12, 0x3a, 0x0a, 0x09, 0x6c, 0x65, 0x76, 0x65,
	...
	,
...
var file_talent_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_talent_proto_goTypes = []interface{}{
	(TalentType)(0),          // 0: gameMessageCore.TalentType
	(TalentGainsType)(0),     // 1: gameMessageCore.TalentGainsType
	...
	(*TalentTreeUpdate)(nil), // 7: gameMessageCore.TalentTreeUpdate
}
var file_talent_proto_depIdxs = []int32{
	...
	0,  // 7: gameMessageCore.TalentTreeUpdate.type:type_name -> gameMessageCore.TalentType
	4,  // 8: gameMessageCore.TalentTreeUpdate.addNodes:type_name -> gameMessageCore.TalentNode
	4,  // 9: gameMessageCore.TalentTreeUpdate.updateNodes:type_name -> gameMessageCore.TalentNode
...
func file_talent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_talent_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TalentTreeUpdate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
