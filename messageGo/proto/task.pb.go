...
const (
	...
	// 寻物任务
	TaskType_TaskTypeGetItem TaskType = 1
	// 使用道具
	TaskType_TaskTypeUseItem TaskType = 2
	// 打怪任务
	TaskType_TaskTypeKillMonster TaskType = 3
	// 寻路任务
	TaskType_TaskTypeMoveTo TaskType = 4
	// Quiz
	TaskType_TaskTypeQuiz TaskType = 5
	// 攻占地块
	TaskType_TaskTypeOccupiedLand TaskType = 6
)
...
var (
	TaskType_name = map[int32]string{
		...
		1: "TaskTypeGetItem",
		2: "TaskTypeUseItem",
		3: "TaskTypeKillMonster",
		4: "TaskTypeMoveTo",
		5: "TaskTypeQuiz",
		6: "TaskTypeOccupiedLand",
	}
...
const (
	...
	// other任务
	TaskListType_TaskListTypeOther TaskListType = 3
)
...
type TaskOptionCnf struct {
	...
	Kind TaskType `protobuf:"varint,1,opt,name=kind,proto3,enum=gameMessageCore.TaskType" json:"kind,omitempty"`
...
func (x *TaskOptionCnf) GetKind() TaskType {
	if x != nil {
		return x.Kind
	}
...
type Task struct {
	...
	// 任务类型
	TaskKind TaskType `protobuf:"varint,2,opt,name=task_kind,json=taskKind,proto3,enum=gameMessageCore.TaskType" json:"task_kind,omitempty"`
	// 任务的接取时间
...
func (x *Task) GetTaskKind() TaskType {
	if x != nil {
		return x.TaskKind
	}
	return TaskType_TaskTypeUnknown
...
var file_proto_task_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x74, 0x61, 0x73, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x2a, 0xa2, 0x01, 0x0a, 0x08, 0x54,
	...
	,
...
var file_proto_task_proto_goTypes = []interface{}{
	(TaskType)(0),             // 0: gameMessageCore.TaskType
...
var file_proto_task_proto_depIdxs = []int32{
	0,  // 0: gameMessageCore.TaskOptionCnf.kind:type_name -> gameMessageCore.TaskType
	...
	0,  // 6: gameMessageCore.Task.task_kind:type_name -> gameMessageCore.TaskType
...
func file_proto_task_proto_init() {
	...
	file_proto_task_proto_msgTypes[4].OneofWrappers = []interface{}{
